...
export default function EditEmployeePage() {
  ...
  React.useEffect(() => {
    ...
    setForm({
      ...
      bankingAddress: employee.bankingAddress ?? "",
      bankingAccountName: employee.bankingAccountName ?? "",
      bankingAccountNumber: employee.bankingAccountNumber ?? "",
      bankingStatus: employee.bankingStatus ?? "Active",
      bankingNote: employee.bankingNote ?? "",
          ...
          >
                      ...
                      <tbody>
                        <tr>
                          <td className="py-2 pr-1">
                            <input
                              name="bankingAddress"
                              value={String(form.bankingAddress)}
                              onChange={onChange}
                              className={inputClass}
                            />
                          </td>
                          <td className="py-2 pr-1">
                            <input
                              ...
                              value={String(form.bankingAccountName)}
                              onChange={onChange}
                              className={inputClass}
                            />
                          </td>
                          <td className="py-2 pr-1">
                            <input
                              ...
                              value={String(form.bankingAccountNumber)}
                              onChange={onChange}
                              className={inputClass}
                            />
                          </td>
                          <td className="py-2 pr-1">
                            <input
                              name="bankingStatus"
                              value={String(form.bankingStatus)}
                              onChange={onChange}
                              className={inputClass}
                            />
                          </td>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12">
                <div className="space-y-1">
                  <FormRow label="Contract Name *" required>
                    <input
                      name="contractName"
                      value={String(form.contractName)}
                      onChange={onChange}
                      className={inputClass}
                    />
                  </FormRow>
                  <FormRow label="Contract Type *" required>
                    <input
                      name="contractType"
                      value={String(form.contractType)}
                      onChange={onChange}
                      className={inputClass}
                    />
                  </FormRow>
                  <FormRow label="Salary Basic *" required>
                    <input
                      name="salaryBasic"
                      value={String(form.salaryBasic)}
                      onChange={onChange}
                      className={inputClass}
                    />
                  </FormRow>
                  ...
                  <FormRow label="Staff Type *" required>
                    <input
                      name="staffType"
                      value={String(form.staffType)}
                      onChange={onChange}
                      className={inputClass}
                    />
                  </FormRow>
                ...
                <div className="space-y-1">
                  ...
                  <FormRow label="Salary Gross">
                    <input
                      name="salaryGross"
                      value={String(form.salaryGross)}
                      onChange={onChange}
                      className={inputClass}
                    />
                  </FormRow>
                  <FormRow label="Salary Capacity *" required>
                    <input
                      name="salaryCapacity"
                      value={String(form.salaryCapacity)}
                      onChange={onChange}
                      className={inputClass}
                    />
                  </FormRow>
