    ...
    return (
      <div className="bg-white min-h-screen p-6">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="rounded-xl border border-gray-200 p-8">
            <div className="text-lg font-semibold text-gray-900">Không tìm thấy bài viết</div>
            <div className="mt-2 text-sm text-gray-600">Vui lòng quay lại danh sách.</div>
            <div className="mt-5">
              <Link
                href="/admin/forum"
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="rounded-xl border border-gray-200 p-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-8">
            <div>
              <div className="text-xl font-bold tracking-wide text-gray-900">{detail.title}</div>
