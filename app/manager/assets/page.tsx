...
import { Download, Package, Search, Shield, Wrench } from "lucide-react";
...
const mockAssignedAssets: AssignedAsset[] = [
  ...
  {
    id: "f7c74c7e-1e32-49b4-9b4b-01e1e5b338b9",
    name: "Điện thoại công việc",
    type: "COMPANY",
    owner: null,
    location: "Phòng Kinh doanh",
    condition: "GOOD",
    purchase_date: "2025-02-20T07:00:00.000Z",
    warranty_expiration_date: "2027-02-20T07:00:00.000Z",
    maintenance_schedule: "2026-08-20T07:00:00.000Z",
  },
  {
    id: "4a5e5a23-e7d7-4d69-a3cb-9f6b2095a5b2",
    name: "Tai nghe Meeting",
    type: "COMPANY",
    owner: null,
    location: "Bàn làm việc",
    condition: "USED",
    purchase_date: "2024-11-05T07:00:00.000Z",
    warranty_expiration_date: "2026-11-05T07:00:00.000Z",
    maintenance_schedule: "2026-05-05T07:00:00.000Z",
  },
];
    ...
    <div className="p-6 bg-background min-h-screen">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="text-lg font-semibold text-grey-900">Tài sản nhân viên đang sở hữu</div>
